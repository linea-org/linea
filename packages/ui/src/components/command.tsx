...
import { InputGroup, InputGroupAddon } from "@linea/ui/components/input-group"
...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      <DialogContent
        className={cn(
          "top-[20vh] translate-y-0 overflow-hidden rounded-xl p-0 sm:max-w-lg",
          className
        )}
      ...
      >
        ...
        <Command className="rounded-xl **:data-[slot=command-input-wrapper]:h-12">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
