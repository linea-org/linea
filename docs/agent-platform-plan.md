...
| Applications          | `POST /v1/applications`, `GET /v1/applications`, `GET /v1/applications/:id`, `PATCH /v1/applications/:id`, `PUT /v1/applications/:id/trust-configuration`, `POST /v1/applications/:id/disable`, `GET /v1/applications/:applicationId/workflow-bindings`, `PUT /v1/applications/:applicationId/workflow-bindings/:workflowId`                                        | Operator control plane             | None               |
