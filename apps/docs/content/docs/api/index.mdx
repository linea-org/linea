...
The API, SDKs, and contract tests consume that registry. OpenAPI and the route
reference will be generated from the same source when that generator lands.
...
<Callout type="info" title="Planned reference generation">
